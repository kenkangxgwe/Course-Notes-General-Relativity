...
\begin{figure}[h]
\centering\includegraphics[scale=.8]{Pictures/Free-falling-observer}
\end{figure}
\begin{alignat*}{2}
...
\begin{figure}[h]
\centering\includegraphics[scale=.8]{Pictures/Accelerating-observer}
\end{figure}
\begin{alignat*}{2}
...
\begin{figure}[h]
\centering\includegraphics[width=\linewidth]{But-not-globally}
\end{figure}
...
\begin{figure}[h]
\centering\includegraphics[]{Pictures/rotation-elementary}
\end{figure}
\begin{align*}
...
\section{Vector and Vector field}\index{Vector, Vector Field}

\subsection{Vector \& metric}\index{Metric}
\begin{itemize}[label={--}, leftmargin=*]
...
\section{Tensor and tensor field}\index{Tensor, Tensor Field}
...
\subsection{Tensor and Representation Theory}\index{Representation}
